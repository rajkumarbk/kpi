...
class Branch(models.Model):
    COMPANY_CHOICES = [
        ("AlSalem Auto Glass", "AlSalem Auto Glass"),
...
class ManufactureYear(models.Model):
    year = models.PositiveIntegerField(
        unique=True, validators=[MinValueValidator(1960), MaxValueValidator(2050)]
    )
...
class Transaction(models.Model):
    ...
    sales_type = models.ForeignKey(
        SalesType, on_delete=models.PROTECT, null=True, blank=True
    )
    parts_type = models.ForeignKey(
        PartsType, on_delete=models.SET_NULL, null=True, blank=True
    )
    ...
    corporate_client = models.ForeignKey(
        CorporateClient, on_delete=models.SET_NULL, null=True, blank=True
    )
    wholesale_company = models.ForeignKey(
        WholesaleCompany, on_delete=models.SET_NULL, null=True, blank=True
    )

    government_org = models.ForeignKey(
        GovernmentOrganization, on_delete=models.SET_NULL, null=True, blank=True
    )
