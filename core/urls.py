...
urlpatterns = [
    ...
    path(
        "ajax/load-corporate-clients/",
        views.load_corporate_clients,
        name="ajax_load_corporate_clients",
    ),
    path(
        "ajax/load-wholesale-companies/",
        views.load_wholesale_companies,
        name="ajax_load_wholesale_companies",
    ),
]
